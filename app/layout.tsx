...
export default async function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="ja">
      <body className={`${inter.variable} min-h-screen antialiased font-sans bg-[radial-gradient(1200px_600px_at_50%_-10%,rgba(34,197,94,0.18),transparent),linear-gradient(180deg,#f0fdf4,#dcfce7)] text-zinc-800`}> 
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <nav className="hidden sm:flex gap-4 text-base sm:text-lg">
                  ...
                  <a href="/list" className="hover:text-orange-900 text-orange-700 transition font-medium">一覧</a>
                </nav>
                <UserSelector />
              </div>
            </div>

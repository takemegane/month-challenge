...
export function CalendarView({ initialMonth }: { initialMonth?: string }) {
  ...
  async function fetchMonthData(m: string) {
    ...
    const params = new URLSearchParams({ user_id: "me", since: start, until: end });
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col items-center">
          <div className="text-2xl sm:text-4xl font-bold text-orange-900/90 whitespace-nowrap">{headerTitle}: {count} 件</div>
